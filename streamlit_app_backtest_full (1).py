...
summary = f"""
**Summary**: The ARIMAX model was trained on historical data through 2022 and backtested against 2023–2024 revenue using CPI ({cpi_input:.2f}%), {txn_input} transactions, and ${mkt_input}M in marketing. The model shows a MAPE of {mape:.2f}%, and a correlation of {correlation:.2f} between expenses and revenue. These metrics suggest [moderate/strong] alignment between cost drivers and top-line results, warranting audit review.
"""
st.markdown(summary)
